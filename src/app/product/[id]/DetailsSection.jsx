...
<div className="font-semibold text-[13px]">0 Reviews</div>
<p>|</p>
<div className="font-semibold text-[13px]">{product.catetitle}</div>
</div>
</div>
...
<p className="text-[13px]"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4">
  <path strokeLinecap="round" strokeLinejoin="round" d="M9 15 3 9m0 0 6-6M3 9h12a6 6 0 0 1 0 12h-3" />
</svg>
</p>
    <p className="font-bold text-[13px]">Return : </p>
    <p className="text-[#E4297B] font-semibold text-[13px]">3 Days</p>
</div>
<div className="flex flex-row gap-3 items-center text-[12px] lg:text-[13px]">
    <p className="text-[13px]"><FontAwesomeIcon icon={faArrowRightArrowLeft} /></p>
...
<div className="flex lg:justify-center items-center font-black lg:text-5xl">
    <p>5.0</p> 
    <p className="text-[12px] lg:text-[25px]">⭐</p>
</div>

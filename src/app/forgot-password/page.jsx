...
import { getCaptcha, resetPasswordWithDOB } from "../../services/api";
...
<div className="">
    ...
    <div className="flex flex-col gap-3">
        ...
        <input 
            ...
            className="w-full p-3 text-center text-xl font-bold tracking-[5px] border border-orange-600 rounded-md outline-none bg-white focus:ring-2 focus:ring-orange-500"
            value={captchaInput}

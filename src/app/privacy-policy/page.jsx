...
<div className='pt-40 xl:pt-20'>
 ...
 <div className="cursor-pointer w-full">
  <div className="flex justify-center items-center">
    <p className="text-5xl font-semibold text-[#114]">Privacy Policy</p>
  </div>
</div>

<div className="pt-5">

<div className="p-5 text-gray-400 font-normal text-[12px]">
  KawsarShop Limited (the “Company”) respects the privacy of its online visitors and customers’ personal information. We follow applicable laws and regulations to protect the data of users of our products and services. This includes following international standards related to privacy and data protection. KawsarShop Limited uses customers’ personal information only for service improvement, order processing, and customer support purposes. We take appropriate technical and organizational security measures to keep your information safe. We do not share your information with third parties without your permission, unless it is required by law.
</div>

<div className="p-5 flex flex-col gap-3">
  <p className="font-bold text-2xl lg:text-3xl">Interpretation and Definitions</p>
  <div>
    <p className="font-bold text-2xl lg:text-3xl">Interpretation</p>
    <p className="text-[12px] mt-3 mb-5">
      The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.
    </p>
  </div>
  <div className="flex flex-col gap-3">
    <p className="font-bold text-2xl lg:text-3xl">Definitions</p>
    ...
    <p><b>Company </b>(referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to  KawsarShop, Mirzapur Tangail, Dhaka.</p>
    ...
    <p><b>Country </b>efers to: Bangladesh</p>
    ...
    <p><b>Usage Data </b>efers to data collected automatically, either generated by the use of the Service or from the Service infrastructure itself (for example, the duration of a page visit).</p>
    <p><b>Website </b>refers to Live Shopping , accessible from  <i>KawsarShop.com</i></p>
  ...
  <div className="flex flex-col gap-3 mt-5">
    <p className="font-black text-2xl lg:text-3xl">Collecting and Using Your Personal Data</p>
    <p className="font-bold text-2xl lg:text-3xl">Types of Data Collected</p>
    <div className="flex flex-col gap-3">
      <p className="font-bold text-2xl">Personal Data</p>
      ...
      <p className="font-bold text-2xl">Usage Data</p>
      <div className="text-[12px] flex flex-col gap-4 mb-5">
      <p>Usage Data is collected automatically when using the Service.</p>
      <p>Usage Data may include information such as Your Device's Internet Protocol address (e.g. IP address), browser type, browser version, the ecom_pages of our Service that You visit, the time and date of Your visit, the time spent on those ecom_pages, unique device identifiers and other diagnostic data.</p>
      <p>When You access the Service by or through a mobile device, We may collect certain information automatically, including, but not limited to, the type of mobile device You use, Your mobile device unique ID, the IP address of Your mobile device, Your mobile operating system, the type of mobile Internet browser You use, unique device identifiers and other diagnostic data.</p>
      <p>We may also collect information that Your browser sends whenever You visit our Service or when You access the Service by or through a mobile device.</p>
      </div>
      <p className="font-bold text-2xl">Information from Third-Party Social Media Services</p>
      <div className="text-[12px] flex flex-col gap-4 mb-5">
        ...
        <p className="font-bold text-2xl">Tracking Technologies and Cookies</p>
        <div className="text-[12px] flex flex-col gap-4 mb-5">
       ...
       <div className="text-[12px] flex flex-col gap-4 mb-5">
         ...
         <p className="font-bold text-2xl">Use of Your Personal Data</p>
         <div className="text-[12px] flex flex-col gap-4 mb-5">
     ...
     <p className="font-bold text-2xl">Retention of Your Personal Data</p>
      <div className="text-[12px] flex flex-col gap-4 mb-5">
   ...
   <p className="font-bold text-2xl">Transfer of Your Personal Data</p>
   <div className="text-[12px] flex flex-col gap-4 mb-5">
   ...
   <p>The Company will take all steps reasonably necessary to ensure that Your data is treated securely and in accordance with this Privacy Policy and no transfer of Your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of Your data and other personal information.</p>
    ...
    <p className="font-bold text-2xl">Delete Your Personal Data</p>
    <div className="text-[12px] flex flex-col gap-4 mb-5">
    <p>You have the right to delete or request that We assist in deleting the Personal Data that We have collected about You.</p>  
    <p>You may update, amend, or delete Your information at any time by signing in to Your Account, if you have one, and visiting the account settings section that allows you to manage Your personal information. You may also contact Us to request access to, correct, or delete any personal information that You have provided to Us.</p>
    <p>Please note, however, that We may need to retain certain information when we have a legal obligation or lawful basis to do so.</p>
    </div>
    <p className="font-bold text-2xl lg:text-3xl">Disclosure of Your Personal Data</p>
    <p className="font-bold text-2xl">Business Transactions</p>
    <div className="text-[12px] flex flex-col gap-4 mb-5">
      <p>If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.</p>
    </div>
    <p className="font-bold text-2xl">Law enforcement</p>
    <div className="text-[12px] flex flex-col gap-4 mb-5">
      <p>Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>
    </div>
    <p className="font-bold text-2xl lg:text-3xl">Security of Your Personal Data</p>
    <div className="text-[12px] flex flex-col gap-4 mb-5">
      <p>The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially acceptable means to protect Your Personal Data, We cannot guarantee its absolute security.</p>
    </div>
    <p className="font-bold text-2xl">Links to Other Websites</p>
    <div className="text-[12px] flex flex-col gap-4 mb-5">
      <p>Our Service may contain links to other websites that are not operated by Us. If You click on a third party link, You will be directed to that third party's site. We strongly advise You to review the Privacy Policy of every site You visit.</p>
      <p>We have no control over and assume no responsibility for the content, privacy policies or practices of any third party sites or services.</p>
    </div>
    <p className="font-bold text-2xl lg:text-3xl">Changes to this Privacy Policy</p>
      <div className="text-[12px] flex flex-col gap-4 mb-5">

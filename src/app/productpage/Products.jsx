...
import ProductQuickView from "../home/_components/ProductQuickView";
...
className="absolute top-0 right-0 h-full w-1/3 z-20 lg:hidden"
/>
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12Z" />
    ...
    <div className="flex flex-col items-start justify-between lg:justify-center p-3 w-full lg:w-1/2">
      ...
      <button
          ...
          className="bg-transparent  outline-2 text-center rounded-md hover:bg-black hover:text-white hover:outline-0 text-red-500 cursor-pointer outline-red-600 p-1 w-50"
        >
          <Link href={``} className="flex flex-row gap-3 justify-center">
            <p>
              <FontAwesomeIcon icon={faCartShopping} />

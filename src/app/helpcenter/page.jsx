...
export default function HelpCenterPage() {
  ...
  return (
    <div className="min-h-screen pt-40 xl:pt-10 bg-white text-gray-900 py-16 px-6 relative capitalize">


      <div className="max-w-5xl mx-auto bg-gray-100 p-4 rounded-xl mb-8 flex items-center gap-3">
        <Info className="text-[#155] w-6 h-6" />
        <p className="text-sm md:text-base text-gray-700">
          Need help? Visit our{" "}
          <Link href={`/supportportal`} className="text-[#155] font-semibold cursor-pointer hover:underline">
      ...
      <section className="max-w-4xl mx-auto mt-16">
        ...
        <div className="space-y-6">
          {faqs.map((f, i) => (
            <div
              key={i}
              className="bg-gray-50 p-5 rounded-xl border border-gray-200 shadow-sm cursor-pointer"
            >
              <h4 className="font-semibold text-lg mb-2 text-[#155]">❓ {f.q}</h4>
      ...
      <div className="mt-16 bg-gray-100 border-t border-gray-200 py-8 text-center rounded-t-xl">
        {feedback ? (
  ...
  className="bg-amber-500 cursor-pointer text-white px-4 py-2 rounded-full flex items-center gap-2"
>
...
<div className="flex gap-3 justify-end">
  ...
  className="bg-amber-500 cursor-pointer text-white px-4 py-1 rounded-full font-semibold">
   Yes
 </button>
 <button

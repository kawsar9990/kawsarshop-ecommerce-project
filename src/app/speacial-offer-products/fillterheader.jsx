...
export default function FillterHeader({
...
return(
   <div className="sticky top-28 xl:top-32 w-full lg:mt-3 z-20 bg-gray-200  text-black rounded-lg shadow-md p-3 mb-3 z-[990]">
...
<div className="flex gap-2 items-center ">
  <p className={`hover:text-red-500 cursor-pointer ${list ? "bg-gray-300 rounded-full p-2 font-bold text-red-500" : "bg-gray-200 text-black"}`}
    onClick={()=> {setList(true); setTitleStyle(false); sessionStorage.setItem("view","list");}}>
<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5">
  ...
  <p className={`hover:text-red-500 cursor-pointer ${titlestyle ? "bg-gray-300 rounded-full p-2 font-bold text-red-500" : "bg-gray-200 text-black"}`}
    onClick={()=> {setTitleStyle(true); setList(false); sessionStorage.setItem("view","title")}}>
<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5">

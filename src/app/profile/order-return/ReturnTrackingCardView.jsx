...
export default function TrackingCardView({ returnHistory = [] }) {
...
<p className="text-[10px] font-bold flex flex-row gap-1 text-slate-800">Order ID <span className='text-[8px]'>#{order._id}</span></p>
<Link href={`/profile/order-return/${order._id}`} className="text-[8px] cursor-pointer text-blue-600 font-medium hover:underline">
    Tracking Orders
</Link>
</div>

...
return(
   ...
   <div className="pt-30 pb-10 md:pt-35 xl:pt-10 flex justify-center items-center">
     <div className="bg-white w-full md:w-[450px] rounded-md p-5 relative transition-all shadow-2xl duration-500">
...
<div className="text-[13px] flex justify-center">
    <div className="flex gap-1">
        ...
        <Link href={`/register`}
        className="text-[12px] font-bold cursor-pointer hover:text-red-500 text-purple-600 hover:underline"
        >Sign Up</Link>
    </div>
</div>

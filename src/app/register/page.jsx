...
<div className=" w-full flex justify-center bg-gradient-to-br from-purple-100 via-pink-100 to-blue-100 items-center min-h-screen p-5">
...
<div className="flex justify-between items-center w-full gap-5">
        ...
        className='text-purple-600 hover:text-pink-500 font-bold text-sm md:text-base'>
     ...
     <div>
          <div className='flex flex-col'>
               <a href="#" className='text-center pt-5 font-black text-xl text-purple-800'>{login ? "login" : "Sign Up"}</a>          
          </div>
          ...
          <div className='pt-7 flex flex-col gap-5'>
              ...
              {!login && (
                <div className='w-full'>
                    <label htmlFor="nam" className='font-bold text-purple-700'>Username</label>
                    <div className='w-full'>
                        <input 
                          value={text}
           ...
           <div className='w-full'>
                    <label htmlFor="pass" className='font-bold text-purple-700'>Password</label>
                    <div className='w-full'>
                        <input 
                          value={password}
  ...
  <a href="" className='text-purple-600 font-semibold hover:text-pink-500 hover:underline text-sm'>Forgot Your Password?</a>
           ...
           <div className='pb-10'>
               <button
                 onClick={loginclick}
                className='w-full p-3 rounded-xl bg-gradient-to-r from-purple-600 via-pink-500 to-red-500 text-white font-bold hover:shadow-lg transition-all duration-300'>
                   {login ? "Login" : "Sign Up"}
               </button>
           </div>

...
>
 ...
 <Image
  ...
  width={300}
  height={200}
  className="w-full h-[180px] object-cover rounded  transition-tra duration-1000 opacity-100 group-hover:opacity-0"
/>
...
<Image
    ...
    width={300}
    height={200}
    className="object-cover rounded absolute inset-0 transition-all duration-500 opacity-0 group-hover:opacity-100"
  />

...
<motion.h1
  ...
  className="text-[10rem] md:text-[14rem] font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-yellow-400 to-green-500 drop-shadow-xl"
>
  404
</motion.h1>
...
<motion.p
  ...
  className="text-3xl md:text-5xl  px-3 font-bold text-center"
>
  Oops! Page Not Found
</motion.p>
...
<motion.p
  ...
  className="text-gray-300 mt-4 px-7 text-[12px] text-center md:text-lg"
>

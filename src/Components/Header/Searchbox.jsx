...
/>
        ...
        <button type="submit" className="text-white absolute cursor-pointer end-2.5 bottom-2.5 bg-[#C6005C] hover:bg-[#b70558] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 ">Search</button>
    </div>
</form>
    </div>
    )

...
<div 
  ...
  className="text-white font-black relative flex items-center justify-center cursor-pointer"
>
...
<button 
  onClick={() => handleProtectedAction(() => router.push('/wishlist'))} 
  className="flex flex-col items-center text-gray-700 active:text-red-600 relative cursor-pointer"
>
